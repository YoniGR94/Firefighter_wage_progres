...
```{r vizualization, warning=FALSE, message=FALSE, echo=F}
#big_6<-fire_full %>%   #sum by country
  #count(State, sort= T,name= "Times_apear") %>%
  #mutate(biggest= order(State)) %>%
  #ungroup()  %>% select(1) %>% top_n(6)
